      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div className="max-w-md">
            ...
            <div className="mt-10 flex flex-col gap-4">
              {[
                ...
                { icon: Shield, label: 'Secure', desc: 'Passwordless client portal with magic links' },
          ...
          <p className="text-white/25 text-xs">
            MCR Partners &times; Apex AI &mdash; Secure Admin Portal
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full lg:w-[45%] flex-col items-center justify-center px-6 sm:px-12 relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="hidden lg:block mb-8">
            ...
            <p className="text-sm text-muted mt-1.5">Sign in to the admin dashboard</p>
          </div>
          ...
          >
            <Input
              ...
              label="Email address"
              type="email"
              placeholder="admin@mcrpartners.com.au"
              value={email}
          ...
          <p className="mt-6 text-center text-xs text-muted">
            Protected admin area. Authorised MCR staff only.
          </p>
        </div>
      </div>
    </div>
